					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Setting Sambutan</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<div id="box" class="alert alert-success hide">
									...
									<input type="hidden" name="id_sambutan" id="id_sambutan" value="<?php echo $id_sambutan;?>">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#update").click(function(){
			...
			var id_sambutan = $("#id_sambutan").val();
			var judul = $("#judul").val();
			var deskripsi = $("#deskripsi").val();

	            	$.ajax({
					type:"POST",
					url:"/adminToko/sambutan_simpan",
					data:"id_sambutan="+id_sambutan+"&judul="+judul+"&deskripsi="+deskripsi,
