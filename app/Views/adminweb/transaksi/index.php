								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										if (count($data_transaksi)>0) {
											foreach ($data_transaksi as $tampil) { ?>
										<tr >
											<td><?php echo $no;?></td>
											...
											<td>
											<a class="btn green" href="/adminToko/transaksi_proses/<?php echo $tampil['id_transaksi_header'];?>"><i class="icon-edit"></i> Proses</a>
											<a class="btn blue" href="/adminToko/transaksi_detail/<?php echo $tampil['id_transaksi_header'];?>/<?php echo $tampil['kode_transaksi'];?>"><i class="icon-search"></i> Detail</a>
