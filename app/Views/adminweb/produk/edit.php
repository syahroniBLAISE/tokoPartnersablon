						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<div id="form_sample_2" class="form-horizontal">
									...
									<?php echo form_open_multipart('/adminToko/produk_update/','class="form-horizontal"'); ?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="nama_produk" id="nama_produk" class="span6 m-wrap" value="<?php echo $nama_produk;?>" />
										</div>
									</div>
									...
									<div class="control-group">
												...
												<div class="controls">
													<select id="select2_sample1" name="brand_id" class="span6 select2">
														<option value=""></option>
														<?php
														foreach ($data_brand as $tampil) { 
															if ($brand_id==$tampil['id_brand']) { ?>
															<option value="<?php echo $tampil['id_brand'];?>" selected="selected"><?php echo $tampil['nama_brand'];?></option>
															<?php
															}
															else { ?>
															<option value="<?php echo $tampil['id_brand'];?>"><?php echo $tampil['nama_brand'];?></option>
															<?php
															}
									...
									<div class="control-group">
												...
												<div class="controls">
													<select id="select2_sample2" name="kategori_id" class="span6 select2">
														<option value=""></option>
														<?php
														foreach ($data_kategori as $tampil) { 
									...
									<div class="form-actions">
										...
										<a href="/adminToko/produk" class="btn white"><i class="icon-long-arrow-left"></i> Kembali</a>
