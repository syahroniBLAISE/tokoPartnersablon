						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<div id="form_sample_2" class="form-horizontal">
									...
									<?php echo form_open_multipart('/adminToko/produk_simpan/','class="form-horizontal"'); ?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="stok" id="stok" class="span6 m-wrap" placeholder="Stok..." />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea class="span12 wysihtml5 m-wrap" rows="6" name="deskripsi" id="deskripsi"  ></textarea>
