							...
							<div class="portlet-body form">
								...
								<div id="box" class="alert alert-success hide">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="nama_kategori" id="nama_kategori" class="span6 m-wrap" value="<?php echo $nama_kategori;?>"/>
										</div>
									</div>
									
									<div class="form-actions">
										<button type="submit" id="update" class="btn green"><i class="icon-ok"></i> Update</button>
										<a href="/adminToko/kategori" class="btn white"><i class="icon-long-arrow-left"></i> Kembali</a>
