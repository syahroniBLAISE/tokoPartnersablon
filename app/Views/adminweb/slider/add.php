						...
						<div class="portlet box">
							...
							<div class="portlet-body form">
								...
								<div id="form_sample_2" class="form-horizontal">
									...
									<?php echo form_open_multipart('/adminToko/slider_simpan/','class="form-horizontal"'); ?>
										...
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												<div class="input-append">
													...
													<input type="file" n ame="userfile" class="default" />
													</span>
									...
									<div class="form-actions">
										...
										<a href="/adminToko/slider" class="btn white"><i class="icon-long-arrow-left"></i> Kembali</a>
