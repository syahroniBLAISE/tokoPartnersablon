			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="btn-group">
						...
						<a  class="btn green" href="/adminHome/halamanTambahTanya/" data-toggle="modal">Add New <i class="icon-plus"></i></a> 
					</div>
					<!-- sesion mesage -->
				</div>
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<tbody>
						...
						if (count($tanyaJawab)>0) {
							foreach ($tanyaJawab as $tanyaJawab) { ?>
						<tr >
							<td><?php echo $no;?></td>
							<td><?php echo $tanyaJawab['pertanyaan'];?></td>
							<td>
								<a class="btn green" href="/adminHome/halamanEditTanya/<?php echo $tanyaJawab['id'];?>"><i class="icon-edit"></i> Edit</a>
								<a class="btn red" href="/adminHome/deleteTanya/<?php echo $tanyaJawab['id'];?>" onclick="return confirm('Yakin Ingin Menghapus <?php echo $tanyaJawab['pertanyaan'];?>?')"><i class="icon-trash"></i> Delete</a>
							</td>
						</tr>
						<?php
						$no++;}}
